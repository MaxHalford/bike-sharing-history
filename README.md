...
| 🇨🇦 | Vancouver | Mobi Bike Share | [`vancouver/mobi-bike-share.geojson`](data/stations/vancouver/mobi-bike-share.geojson) | [`vancouver.json`](data/weather/vancouver.json) |
...
| 🇫🇷 | Belfort | Optymo | [`belfort/optymo.geojson`](data/stations/belfort/optymo.geojson) | [`belfort.json`](data/weather/belfort.json) |
...
| 🇫🇷 | Bordeaux | Bird | [`bordeaux/bird.geojson`](data/stations/bordeaux/bird.geojson) | [`bordeaux.json`](data/weather/bordeaux.json) |
| 🇫🇷 | Bordeaux | VCub | [`bordeaux/vcub.geojson`](data/stations/bordeaux/vcub.geojson) | [`bordeaux.json`](data/weather/bordeaux.json) |
| 🇫🇷 | Brest | Donkey Republic | [`brest/donkey-republic.geojson`](data/stations/brest/donkey-republic.geojson) | [`brest.json`](data/weather/brest.json) |
| 🇫🇷 | Carcassonne | Cyclolib | [`carcassonne/cyclolib.geojson`](data/stations/carcassonne/cyclolib.geojson) | [`carcassonne.json`](data/weather/carcassonne.json) |
...
| 🇫🇷 | Châlons-en-Champagne | Bird | [`chalons-en-champagne/bird.geojson`](data/stations/chalons-en-champagne/bird.geojson) | [`chalons-en-champagne.json`](data/weather/chalons-en-champagne.json) |
| 🇫🇷 | Clermont-Ferrand | C-Vélo | [`clermont-ferrand/c-velo.geojson`](data/stations/clermont-ferrand/c-velo.geojson) | [`clermont-ferrand.json`](data/weather/clermont-ferrand.json) |
| 🇫🇷 | Créteil | JCDecaux | [`creteil/jcdecaux.geojson`](data/stations/creteil/jcdecaux.geojson) | [`creteil.json`](data/weather/creteil.json) |
| 🇫🇷 | Créteil | CristoLib | [`creteil/cristolib.geojson`](data/stations/creteil/cristolib.geojson) | [`creteil.json`](data/weather/creteil.json) |
| 🇫🇷 | Draguignan | Bird | [`draguignan/bird.geojson`](data/stations/draguignan/bird.geojson) | [`draguignan.json`](data/weather/draguignan.json) |
| 🇫🇷 | La Roche-sur-Yon | Bird | [`la-roche-sur-yon/bird.geojson`](data/stations/la-roche-sur-yon/bird.geojson) | [`la-roche-sur-yon.json`](data/weather/la-roche-sur-yon.json) |
| 🇫🇷 | Laval | Bird | [`laval/bird.geojson`](data/stations/laval/bird.geojson) | [`laval.json`](data/weather/laval.json) |
| 🇫🇷 | Lille | V'lille | [`lille/v-lille.geojson`](data/stations/lille/v-lille.geojson) | [`lille.json`](data/weather/lille.json) |
...
| 🇫🇷 | Marseille | Bird | [`marseille/bird.geojson`](data/stations/marseille/bird.geojson) | [`marseille.json`](data/weather/marseille.json) |
| 🇫🇷 | Marseille | Lime | [`marseille/lime.geojson`](data/stations/marseille/lime.geojson) | [`marseille.json`](data/weather/marseille.json) |
| 🇫🇷 | Millau | Bird | [`millau/bird.geojson`](data/stations/millau/bird.geojson) | [`millau.json`](data/weather/millau.json) |
| 🇫🇷 | Montluçon | Bird | [`montlucon/bird.geojson`](data/stations/montlucon/bird.geojson) | [`montlucon.json`](data/weather/montlucon.json) |
| 🇫🇷 | Montpellier | Vélomagg' | [`montpellier/velomagg.geojson`](data/stations/montpellier/velomagg.geojson) | [`montpellier.json`](data/weather/montpellier.json) |
...
| 🇫🇷 | Nantes | Bicloo | [`nantes/bicloo.geojson`](data/stations/nantes/bicloo.geojson) | [`nantes.json`](data/weather/nantes.json) |
| 🇫🇷 | Paris | Lime | [`paris/lime.geojson`](data/stations/paris/lime.geojson) | [`paris.json`](data/weather/paris.json) |
| 🇫🇷 | Rouen | JCDecaux | [`rouen/jcdecaux.geojson`](data/stations/rouen/jcdecaux.geojson) | [`rouen.json`](data/weather/rouen.json) |
| 🇫🇷 | Rouen | Cy'clic | [`rouen/cy-clic.geojson`](data/stations/rouen/cy-clic.geojson) | [`rouen.json`](data/weather/rouen.json) |
| 🇫🇷 | Saint-Etienne | Vélivert | [`saint-etienne/velivert.geojson`](data/stations/saint-etienne/velivert.geojson) | [`saint-etienne.json`](data/weather/saint-etienne.json) |
| 🇫🇷 | Sarreguemines | Bird | [`sarreguemines/bird.geojson`](data/stations/sarreguemines/bird.geojson) | [`sarreguemines.json`](data/weather/sarreguemines.json) |
...
| 🇫🇷 | Valenciennes | Donkey Republic | [`valenciennes/donkey-republic.geojson`](data/stations/valenciennes/donkey-republic.geojson) | [`valenciennes.json`](data/weather/valenciennes.json) |
| 🇫🇷 | Vannes | Vélocéo | [`vannes/veloceo.geojson`](data/stations/vannes/veloceo.geojson) | [`vannes.json`](data/weather/vannes.json) |
| 🇫🇷 | Vichy | Bird | [`vichy/bird.geojson`](data/stations/vichy/bird.geojson) | [`vichy.json`](data/weather/vichy.json) |
...
| 🇺🇸 | San Francisco Bay Area | Bay Wheels | [`san-francisco-bay-area/bay-wheels.geojson`](data/stations/san-francisco-bay-area/bay-wheels.geojson) | [`san-francisco-bay-area.json`](data/weather/san-francisco-bay-area.json) |
