...
This repo tracks the status of bike stations from various bike-sharing providers. The data is fetched every 20 minutes. The results are stored and versioned as [GeoJSON](https://www.wikiwand.com/en/GeoJSON) files. This is done using the [git scraping](https://simonwillison.net/2020/Oct/9/git-scraping/) technique.

The weather forecast for the next 24 hours is also collected every 20 minutes, for each city.
