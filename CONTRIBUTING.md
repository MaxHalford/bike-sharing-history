...
Railway scrapes live station data every 12 minutes and weather data hourly. Its container and schedule are defined by `Dockerfile`, `railway.toml`, and `scripts/railway-scrape.sh`.
